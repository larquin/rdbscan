...
Gem::Specification.new do |spec|
  spec.name          = "rdbscan"
  spec.version       = Rdbscan::VERSION
  spec.authors       = ["Micah Adams"]
  spec.email         = ["micah.shawn.adams@gmail.com"]

  spec.summary       = "automagic read only models"
  spec.homepage      = "https://github.com/larquin/rdbscan"
  spec.license       = "MIT"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/larquin/rdbscan"
    spec.metadata["changelog_uri"] = "https://github.com/larquin/rdbscan"
  else
